...
```{r}
x <- 42 # means x gets the value 42
```
...
```{r}
z=10 # this will work but will create problems eventually, dont use =
```
...
```{r}
mean(c(2,8,2)) #c stands for combine and creates vector
```
