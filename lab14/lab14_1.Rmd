...
```{r}
ggmap(map1) +
  geom_point(data=spiders, aes(longitude, latitude), size=0.75, color="darkred", alpha=.8)+
...
```{r}
ggmap(map1) +
  geom_point(data=grizzly, aes(longitude, latitude), size=0.75, color="chocolate4", alpha=.8)+
  labs(x="Longitude", y="Latitude", title="Alaska Ursa Horiblus")
```
