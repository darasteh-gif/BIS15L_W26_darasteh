...
In short, **plot= data + geom_ (plot type)+ aesthetics**.  
...
```{r}
ggplot(data=penguins, #specifies the data
      mapping=aes(x=species, y=flipper_length_mm))+ #map the aesthetics
geom_boxplot()
```
...
```{r}
ggplot(data=penguins,#specifies the data
      mapping=aes(x=flipper_length_mm, y=body_mass_g))+ #map the aesthetics
geom_point(na.rm=T)
```
...
ggplot(data=penguins, #specifies the data
      mapping=aes(x=body_mass_g, y=flipper_length_mm))+ #map the aesthetics
geom_point(na.rm=T)+geom_smooth(method=lm, se=T)
```
...
ggplot(data=penguins, #specifies the data
      mapping=aes(x=bill_length_mm, y=bill_depth_mm))+ #map the aesthetics
  geom_point(mapping=aes(color=species, shape=island))+
  geom_smooth(na.rm=T, method=lm, se=T,)+
...
```{r}
ggplot(data=penguins, #specifies the data
      mapping=aes(x=island))+ #map the aesthetics
  geom_bar(mapping=(aes(color=species)))
