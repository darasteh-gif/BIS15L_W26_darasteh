...
///The study is testing the affect that increased ivory harvesting has on the tusk size of elephants. The variables are time (before and after severe tusk harvesting), tusk length, tusk circumference, sex, and social group.
...
#   mutate(elephant_id=as.factor(elephant_id)) %>% 
...
#   summarize(mean_tusk_length_set1=mean(tusk_length_in_cm, na.rm=T))
...
#   summarize(mean_tusk_length_set2=mean(tusk_length_in_cm, na.rm=T))
```
