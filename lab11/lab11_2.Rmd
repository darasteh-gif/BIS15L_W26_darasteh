...
q<-homerange %>% 
  ...
  geom_point()+
  geom_smooth(method="lm", se=F, color="darkcyan")
```
...
```{r}
my_palette <- paletteer_d("calecopal::agriculture")
my_palette
```
...
homerange %>% 
  ...
  geom_density(fill="steelblue", alpa=.3)+
...
homerange %>% 
  ...
  geom_density(fill="darkcyan", alpha=.3)+
